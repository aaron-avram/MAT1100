...
\begin{enumerate}
    ...
    \begin{proof}
        ...
        \[ f_{\frac{1}{a}, -\frac{b}{a}} \circ f_{a, b} = f_{\frac{1}{a} \cdot a, \frac{1}{a}b - \frac{b}{a}} = f_{1, \frac{b}{a} - \frac{b}{a}} = f_{1, 0} \]
    ...
    \begin{proof}
        ...
        hence $\varphi$ is surjective and to show that $\varphi$ is injective,
        note that
        \[ f_{a, b}A_0 = \{ f_{\alpha, \frac{b}{a}\alpha} : \alpha \in \mathbb R^\times \} \]
        hence $f_{a, b}A_0 = f_{c, d}A_0$ if and only if $\frac{b}{a} = \frac{d}{c}$. Each coset
        contains exactly one function of the form $x + \ell$, by taking $\alpha = 1$ in the above parametrizations.
        Denote these by $f_{1, k}$ and $f_{1, k'}$ respectively
        and therefore equality of the cosets holds
        if and only if $k = k'$ which is equivalent to having $\frac{b}{a} = \frac{d}{c}$ above.

        but $\varphi(f_{a, b}A_0 ) = \frac{b}{a}$ and $\varphi(f_{c, d}A_0) = \frac{d}{c}$ hence
        the above becomes:
        \[  f_{a, b}A_0 = f_{c, d}A_0 \iff \varphi(f_{a, b}A_0) = \varphi(f_{c, d}A_0) \] 
        which is precisely what it means for $\varphi$ to be injective.
